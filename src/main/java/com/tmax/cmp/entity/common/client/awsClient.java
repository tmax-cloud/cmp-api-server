...
public class awsClient implements Client{
    ...
    private static final List<Region> REGIONS = List.of(Region.AP_SOUTH_1, Region.EU_SOUTH_1, Region.CA_CENTRAL_1, Region.EU_CENTRAL_1, Region.US_WEST_1, Region.US_WEST_2, Region.EU_NORTH_1, Region.EU_WEST_3, Region.EU_WEST_2, Region.EU_WEST_1, Region.AP_NORTHEAST_3, Region.AP_NORTHEAST_2, Region.AP_NORTHEAST_1, Region.SA_EAST_1, Region.AP_EAST_1, Region.CN_NORTH_1, Region.AP_SOUTHEAST_1, Region.AP_SOUTHEAST_2, Region.US_EAST_1, Region.US_EAST_2);
